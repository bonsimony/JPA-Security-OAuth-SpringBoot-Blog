...
public class DummyControllerTest {
	...
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) {//json 데이터를 요청 => Java Object(MessageConverter의 Jackson 라이브러리)로 변환해서 받아줘요.
...
//		requestUser.setUsername("ssar");
	...
	//http://localhost:8000/blog/dummmy/user
	...
	public User detail(@PathVariable int id) {
		...
		//user/4번을 찾으면 내가 데이터베이스에서 못찾아오게 되면 user가 null이 될 것 아냐?
...
//		});
	...
	//http://localhost:8000/blog/dummy/join (요청) //http의 body에 username,
    // password, email 데이터를 가지고 (요청)
